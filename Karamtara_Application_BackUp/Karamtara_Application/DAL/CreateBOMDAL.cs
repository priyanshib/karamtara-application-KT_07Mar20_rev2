...
namespace Karamtara_Application.DAL
{
    public class CreateBOMDAL
    {
        ...
        public int SaveBOMDetails(FormCollection form)
        {
            ...
            try
            {
                ...
                {
                    bomMasterStatus += InsertData_BomMaster(Convert.ToInt32(prodIdList[i]), Convert.ToInt32(typeList[i]), bomId, revId, TNumber);
                    updateTableStatus += UpdateBOMTables(Convert.ToInt32(prodIdList[i]), Convert.ToInt32(typeList[i]), bomId, revId);
                }
        ...
        public int UpdateBOMTables(int prodId, int prodType, int bomId, int revId)
        {
            connection = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            DataSet ds = new DataSet();
        ...
        public int InsertData_BomMaster(int prodId, int type, int bomId, int revId, string tNumber)
        {
            connection = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            DataSet ds = new DataSet();
            ...
            try
            {
                cmd = new SqlCommand("sp_InsertData_BomMaster", connection);
                cmd.Parameters.Add(new SqlParameter("@prodId", prodId));
                cmd.Parameters.Add(new SqlParameter("@type", type));
                cmd.Parameters.Add(new SqlParameter("@bomId", bomId));
                cmd.Parameters.Add(new SqlParameter("@revNo", revId));
        ...
        public void SendBOMCreatedEmail(int bomId, int revNo)
        {
            ...
            try
            {
                ...
                {
                    Send_BOMCreated_Email(receiverList,projName,custName,revNo);
                }
            }
            catch (Exception ex)
            {
        ...
        public void Send_BOMCreated_Email(List<string> receivers,string projName,string custName,int revNo)
        {
