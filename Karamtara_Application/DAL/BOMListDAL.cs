...
namespace Karamtara_Application.DAL
{
    public class BOMListDAL
    {
        ...
        public BOMListModel GetBOMList(int userId)
        {
            ...
            try
            {
                ...
                if (ds.Tables[2] != null)
                {
                    for (int i = 0; i < ds.Tables[2].Rows.Count; i++)
                    {
                        ...
                        model.IsKTTndCreated = Convert.ToBoolean(ds.Tables[2].Rows[i]["IsKTTndCreated"]);
                        model.IsIselfaTndCreated = Convert.ToBoolean(ds.Tables[2].Rows[i]["IsIselfaTndCreated"]);
        ...
        public BOMListModel SearchBOMList(string prefix, int userId)
        {
            CreateBOMModel bomModel = new CreateBOMModel();
            connection = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
