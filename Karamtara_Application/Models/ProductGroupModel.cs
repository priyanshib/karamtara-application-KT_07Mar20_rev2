...
namespace Karamtara_Application.Models
{
    public class ProductGroupModel
    {
        ...
        public List<BundleSpacing> BundleSpacingList { get; set; }
        public int Quantity { get; set; }
        public decimal UnitGrWt { get; set; }
        public decimal UnitNetWt { get; set; }
        public string Size { get; set; }
        public string DrawingNo { get; set; }
        public int ConductorNameId { get; set; }
        public string ConductorName { get; set; }
        public string BundleSpacing { get; set; }
        public int BundleSpacingId { get; set; }
